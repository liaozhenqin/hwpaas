...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.CseSpringCodegen", date = "2017-11-17T13:36:11.654Z")

@RestSchema(schemaId = "hwpaas")
@RequestMapping(path = "/alantest01", produces = MediaType.APPLICATION_JSON)
public class HwpaasImpl {

    @Autowired
    private HwpaasDelegate userHwpaasDelegate;
    ...
    public Integer add( @RequestParam(value = "a", required = true) Integer a, @RequestParam(value = "b", required = true) Integer b){
        ...
        return userHwpaasDelegate.add(a, b);
    }
    ...
    public String sayHei( @RequestHeader(value="name", required=true) String name){
        ...
        return userHwpaasDelegate.sayHei(name);
    }
    ...
    public String sayHello( @PathVariable("name") String name){
        ...
        return userHwpaasDelegate.sayHello(name);
    }
    ...
    public String sayHi( @RequestParam(value = "name", required = true) String name){
        ...
        return userHwpaasDelegate.sayHi(name);
    }
    ...
    public String saySomething( @RequestParam(value = "prefix", required = true) String prefix, @RequestBody Person user){
        ...
        return userHwpaasDelegate.saySomething(prefix, user);
    }
